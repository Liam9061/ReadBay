...
namespace ReadBay.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        //Role Manager & UnitOfWork injected using dependency injection
        ...
        {
            // For drop down role & company list
            ReturnUrl = returnUrl;
